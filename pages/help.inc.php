...
if (!class_exists('Parsedown')) {
	require($REX['INCLUDE_PATH'] . '/addons/eloquent/classes/class.parsedown.inc.php');
}

// chapters
$chapterpages = array (
	'' => array($I18N->msg('eloquent_help_chapter_readme'), 'pages/help/readme.inc.php'),
    'eloquendocs' => array($I18N->msg('eloquent_help_chapter_docs'), 'pages/help/docs.inc.php'),
    'querybuilder' => array($I18N->msg('eloquent_help_chapter_queries'), 'pages/help/querybuilder.inc.php'),
	'changelog' => array($I18N->msg('eloquent_help_chapter_changelog'), 'pages/help/changelog.inc.php'),
	'license' => array($I18N->msg('eloquent_help_chapter_license'), 'pages/help/license.inc.php'),
);
